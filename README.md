# Ornix Exchange API Documentation
...
The Ornix Exchange API provides developers with direct access to our decentralized exchange infrastructure built on the Solana blockchain. Our API offers the best rates and lowest slippage for token swaps.

**Base URL:** `https://api.ornix.xyz/v1`
...
To get started with the Ornix Exchange API:
...
```bash
curl https://api.ornix.xyz/v1/tokens
```
...
```bash
curl "https://api.ornix.xyz/v1/swap/quote?inputMint=So11111111111111111111111111111111111111112&outputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&amount=1000000000&slippageBps=50"
```
...
```bash
curl "https://api.ornix.xyz/v1/price?ids=So11111111111111111111111111111111111111112,EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"
```
...
**WebSocket URL:** `wss://ws.ornix.xyz`

**JavaScript Example:**

```javascript
const ws = new WebSocket('wss://ws.ornix.xyz');

ws.onopen = () => {
  console.log('Connected to Ornix Exchange');
...
- **Website:** [https://ornix.xyz](https://ornix.xyz)
- **GitHub:** [https://github.com/ornixswap/ornix-api](https://github.com/ornixswap/ornix-api)
- **Twitter:** [https://x.com/ornixswap](https://x.com/ornixswap)

## Support

For support, questions, or feature requests:

- Open an issue on [GitHub](https://github.com/ornixswap/ornix-api)
- Follow us on [Twitter](https://x.com/ornixswap)
- Visit our website at [ornix.xyz](https://ornix.xyz)
